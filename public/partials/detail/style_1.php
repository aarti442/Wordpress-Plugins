<?php
/** 
 * The file used to manage detail page style 1.
 * 
...
if ($bcp_portal_template && ($product_show || $solutions_show || $attachments_show || $casecomments_show || $notes_show || ($subpanel_option && !empty($subpanels)) ) ) {
    ...
    if ($product_show || $solutions_show || $attachments_show || $casecomments_show || $notes_show ) {
        $class1 = "bcp-col-lg-6";
        $class2 = "bcp-col-lg-6";
    } else if($subpanel_option && !empty($subpanels)) {
        $class1 = "bcp-col-lg-4";
        $class2 = "bcp-col-lg-8";
    } else {
        $class1 = "bcp-col-lg-12";
        $class2 = "bcp-col-lg-12";
        $class_div = "full-width-div";
        $class_row = '';
        $classrow = 'bcp-row';
    }
}
...
<div class="bcp-detail-style-1">
        ...
        <div class="case-details-view bg-white ">
            ...
            <div class="bcp-flex bcp-justify-content-between bcp-align-center">
                ...
                <div class="bcp-button-group bcp-flex">
                    <?php if ($show_edit_button && $edit_option && (($RecordCreatedByContact != "" && $RecordCreatedByContact == $_SESSION['bcp_contact_id'])|| $module_name == 'account')) { ?>
                        <?php $url = 'customer-portal/' . $module_name . '/edit/' . $record_id; ?>
                        <a href="<?php echo home_url($url); ?>" title="<?php _e('Edit', 'bcp_portal'); ?>">
                            <button class="action-btn edit">
                                <span class="lnr lnr-pencil"></span>
                                    <?php _e("Edit", 'bcp_portal'); ?>
                            </button>
                        </a>
                    <?php } ?>
    ...
    <div class="<?php echo $class_row; ?>">
        <!--Class div Start -->
        <div class="<?php echo $class1; ?> <?php echo $class_div; ?>">
            <!-- bg-white div Start -->
            <div class="bg-white">
        ...
        <?php if ($product_show || $solutions_show || $attachments_show || $casecomments_show || $notes_show || ($subpanel_option && !empty($subpanels)) ) { ?>
            ...
            <div class="<?php echo $class2; ?> tab-details-1">
                <div class="bg-white">
                        ...
                        <ul class="tabs">
                            ...
                            <?php 
                                ...
                                foreach($subpanels as $k => $subpanel) {
                                    ...
                                    if( $current == "" && strtolower($subtab) == strtolower($subpanel['moduleName'].'-'.$subpanel['relationshipId']) ) {
                                        $current = 'current';
                                    }
                                ...
                                <ul class='dropdown'>
                                    <?php
                                        foreach($subpanels as $subpanel) {
                                            ...
                                            if($subpanel['moduleName'] == "Product"){
                                                $subpanel['moduleName'] = $subpanel['childRelationshipName'];
                                            }
                                        ?>
