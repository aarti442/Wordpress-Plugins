<?php
/** 
 * The file used to manage edit form style 1.
 * 
 ...
 */
?>
<!-- case-listing-block-1 Start -->
<div class="case-listing-block case-listing-block-1 sfcp-form-block">
            ...
            <div class="bcp-col-lg-12">
                ...
                <div class="add-case-block">
                    ...
                    <form method="post" enctype="multipart/form-data" class="module-form module-<?php echo $module_name; ?> ">
                                                    ...
                                                    if (isset($option_values) && count($option_values) > 0) {
                                                        ...
                                                        <div class="bcp-col-lg-4" <?php echo $hideFields; ?>>
                                                            <div class="bcp-form-group">
                                                                ...
                                                                <select class="custom-select <?php echo $class; ?>" <?php echo ($field_information['type'] == 'multi-select') ? ' multiple' : ''; ?> id="<?php echo $name; ?>" <?php echo $disabled; ?> name="<?php echo $field_name; ?>" <?php echo $validationMessage; ?> <?php echo $required; ?> form-type="select" module_name="<?php echo $module_name; ?>">
                        ...
                        ?>
                        <!-- bcp-col-lg-12 text-center Start -->
                        <div class="bcp-col-lg-12 text-center">
                            <div class="case-button-group">
                                ...
                                <?php if ($record_id != "" && $module_name != "contact") { ?>
                                    <button type="button" class="bcp-btn bcp-gray" onclick="window.location = document.referrer
"><?php _e('Cancel', 'bcp_portal'); ?></button>
                                <?php } ?>
                            </div>
                        </div> <!-- bcp-col-lg-12 text-center End -->
