<?php
/** 
 * The file used to manage recent activity style 5.
 * 
 ...
 */
?>
<!-- Recent activity style-5 Start -->
<div class="bcp-recent-activity-style-5 bcp-block-div">
    ...
    <div class="dcp-content-table">
        ...
        <?php if ($field_values) { ?>
                ...
                <table class="dcp-table">
                    <thead class="dcp-head">
                        <tr>
                            ...
                            <?php if ($module_name == 'contentdocument') { ?>
                                <th></th>
                            <?php } ?>
                    ...
                    <tbody>
                        ...
                        foreach ($field_values as $item) {
                            ...
                            if ($module_name == 'contentdocument') {
                                $ftype = isset($item['FileExtension']) ? $item['FileExtension'] : "";
                            ...
                            <tr>
                                ...
                                <?php if ($module_name == 'contentdocument') { ?>
                                    <td>
                                        <a title="<?php _e('Download'); ?>" href="<?php echo admin_url('admin-ajax.php'); ?>?action=bcp_attachment_download&record_id=<?php echo $rec_id; ?>&title=<?php echo $name; ?>&type=<?php echo $ftype; ?>" class="scp-download sfcp-btn-download">
            ...
            <?php if (count($field_values) >= 5) { ?>
                <div class="view-all-records"><a class="view-all" href="<?php echo $view_all_url; ?>" title="<?php _e("View All", 'bcp_portal'); ?>"><?php _e("View All", 'bcp_portal'); ?></a></div>
            <?php } ?>
        <?php } else { ?>
