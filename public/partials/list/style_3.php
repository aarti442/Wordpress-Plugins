<?php
/** 
 * The file used to manage list page style 3.
 * 
...
?>
<!-- listing-3 style-3 Start -->
<div class="listing-3 <?php echo $cls; ?>">
    <!-- listing-style-3 Start -->
    <div class="listing-block listing-style-3">
                                ...
                                <?php if (!empty($list_records['Action'])) { ?>
                                    <td class="dcp_hover_td listing-action text-center">
                                        <?php if ($module_name == 'order' && (isset($records['Status']) && $records['Status'] == 'Activated')) { ?>
                                            <a class="bcp-action" href="javascript:void(0);"><span>-</span></a>
                                            <?php
                                            continue;
    ...
    if ($list_records != null) {
        ...
        echo $action_class->bcp_pagination($total_records, $limit, $paged, $module_name, $action, $order_by, $search, $style = 'style_3');
    }
    ?>
</div>
<!-- listing-3 style-3 Start -->