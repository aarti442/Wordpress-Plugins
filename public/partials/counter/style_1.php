<?php
/** 
 * The file used to manage counter style 1.
 * 
...
?>
<!-- Counter style 1 Start-->
<div id="<?php echo $counter_block_id; ?>" class="<?php echo $module_name; ?>-counter-block number-block number-incident-block block-style-1 bcp-block-div" >
    <div class="card-body">
        <div class="bcp-row">
            ...
            <div class="bcp-col-auto">
                <em class="fa <?php echo $icon; ?>" aria-hidden="true"></em>
            </div>
        </div>
    </div>
</div>
