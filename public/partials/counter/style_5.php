<?php
/** 
 * The file used to manage counter style 5.
 * 
 ...
 */
?>
<!-- Counter style 5 Start-->
<div id="<?php echo $counter_block_id; ?>" class="<?php echo $module_name; ?>-counter-block call-block number-incident-block counter-block-style-5 bcp-block-div">
    <div class="card-body">
        <div class="bcp-row">
