<?php
/** 
 * The file used to manage counter style 3.
 * 
...
<div id="<?php echo $counter_block_id; ?>" class="<?php echo $module_name; ?>-counter-block number-block number-incident-block counter-block-style-3 bcp-block-div">
    <div class="card-body">
        <div class="bcp-row">
